...
def ALU4bits(a, b, alu_operation, result, zero):
    ...
    c1 = Signal(intbv(0)[1:]) # create c2, c3, c4
    c2 = Signal(intbv(0)[1:]) 
    c3 = Signal(intbv(0)[1:]) 
    c4 = Signal(intbv(0)[1:]) 
    ...
    result0 = Signal(intbv(0)[1:]) # create 4 instances of result 
    ...
    alu1_0 = ALU1bit(a(0), b(0), bnegate, bnegate, operation, result0, c1); # create instances of alu1 4 times
    ...
    def comb_output():
        ...
        result.next[0] = result0    # setting the indiviual bit results
